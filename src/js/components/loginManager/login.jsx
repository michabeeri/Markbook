define(
    ['lodash', 'react', 'router', 'components/loginManager/login-fields/email', 'components/loginManager/login-fields/password', 'components/loginManager/loginManager', 'constants', 'ReduxSimpleRouter', 'reactRedux', 'actionProviders/actions', 'components/loginManager/errorMessage'],
    function (_, React, ReactRouter, EmailInput, PasswordInput, LoginManager, Constants, ReduxSimpleRouter, ReactRedux,
        ActionProvider, ErrorMessage) {
        'use strict';
            ...
            displayName: 'LoginFooter', render: function () {
                return (
                    <footer className='footer'>
                        <h4 className='title-small'>Don't have an account? <SignupLink {...this.props}/></h4>
                    </footer>
                );
            }
        });
        ...
        var SignupLink = React.createClass({
            displayName: 'SignupLink', clickHandler: function (event) {
                ...
                return (
                    <a className='btn btn-inline' href='#' onClick={this.clickHandler}>Sign Up</a>
                );
            }
        });
        ...
        var LoginForm = React.createClass({
            ...
            getInitialState: function () {
                ...
                LoginManager.authenticateUser(this.refs.email.getValue(), this.refs.password.getValue(),
                    this.successLogin, this.failureLogin);
            }, render: function () {
                return (
