define(['React', 'reactDOM', 'components/modals/ModalContainer', 'constants'], function (React, ReactDOM, ModalContainer, constants) {
    'use strict';
    ...
    describe('Modal Container', function () {
        function createDemoModalContainer(type) {
            ...
            return TestUtils.renderIntoDocument(<ModalContainer dispatch={callback} state={state}/>);
        }
